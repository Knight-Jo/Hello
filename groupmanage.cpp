...
int creat_group( string gname ,int ownernumber, int maxnumbers)
{
	
	int id = GroupHandler.init_number_ + GroupHandler.getGroup_count() ;  
	GroupTalk *group = new GroupTalk(id , gname , ownernumber, maxnumbers ) ;
...
int CreatGroup(string buffer)
{
	...
	int id = creat_group(name , ownernumber , maxnumbers ) ;  
...
GroupTalk::GroupTalk(int id, string name, int ownernumber,
		int maxnumbers )
	: gid_(id) , gname_(name), gowner_number_(ownernumber), gmax_number_(maxnumbers)
{}

GroupTalk::GroupTalk(int id, string name, int ownernumber,
		int maxnumbers, vector<int> usernumbers)
	: gid_(id) , gname_(name), gowner_number_(ownernumber),
   	gmax_number_(maxnumbers),	m_numbers_(usernumbers)
{} 
